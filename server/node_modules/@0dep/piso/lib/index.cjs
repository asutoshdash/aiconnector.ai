 ...
 * @param {number} Y UTC full year
 */
function getUTCLastWeekOfYear(Y) {
...
exports.getISOWeekString = getISOWeekString;
exports.getStartAt = getStartAt;
exports.getUTCLastWeekOfYear = getUTCLastWeekOfYear;
exports.getUTCWeekNumber = getUTCWeekNumber;
exports.getUTCWeekOneDate = getUTCWeekOneDate;
